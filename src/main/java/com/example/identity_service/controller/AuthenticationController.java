...
public class AuthenticationController {
    ...
    @PostMapping("/token")
    ApiResponse<AuthenticationResponse> authenticate(@RequestBody AuthenticatonRequest request){
    ...
    @PostMapping("/refresh")
    ApiResponse<AuthenticationResponse> authenticate(@RequestBody RefreshRequest request) //AuthenticatonResponse là kiểu trả về của funtion này
            throws ParseException, JOSEException {
